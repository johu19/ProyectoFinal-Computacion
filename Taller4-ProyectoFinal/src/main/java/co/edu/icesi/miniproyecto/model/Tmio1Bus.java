...
public class Tmio1Bus implements Serializable {
	...
	@NotNull(message="Digite la capacidad")
	private BigDecimal capacidad;

	@NotBlank(message="Digite la marca")
	private String marca;

	@NotNull(message="Digite el modelo")
	private BigDecimal modelo;

	@NotBlank(message="Digite la placa")
	private String placa;

	@NotNull(message="Seleccione el tipo de bus")
